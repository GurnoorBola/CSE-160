...
function handleDrawEvent() {
  ...
  ctx.fillRect(0, 0, canvas.width, canvas.height);
  var v1 = new Vector3([
    parseFloat(document.getElementById("v1_x").value),
    parseFloat(document.getElementById("v1_y").value),
    0,
  ]);
  drawVector(v1, "red");
  var v2 = new Vector3([
    parseFloat(document.getElementById("v2_x").value),
    parseFloat(document.getElementById("v2_y").value),
    0,
  ]);
  drawVector(v2, "blue");
}
